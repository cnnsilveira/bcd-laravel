<aside class="bcd__sidebar">
	...
	<nav class="bcd__sidebar--nav">
		<ul class="bcd__sidebar--list">
			<li class="bcd__sidebar--item index">
				<div class="bcd__sidebar--tip">Dashboard</div><a href="#"><i class="fa-solid fa-chart-pie"></i></a>
			</li><!-- .bcd__sidebar--item -->
			<li class="bcd__sidebar--item">
				<div class="bcd__sidebar--tip">Voltar para o site</div><a href="#"><i class="fa-solid fa-angles-left"></i></a>
			</li><!-- .bcd__sidebar--item -->
			<li class="bcd__sidebar--item">
				<div class="bcd__sidebar--tip">Log out</div><a href="#"><i class="fa-solid fa-right-from-bracket"></i></a>
			</li><!-- .bcd__sidebar--item -->
